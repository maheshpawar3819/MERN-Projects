  ...
  return (
    <div className="ml-72 mt-20 p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {/* Category Card */}
        <div className="bg-yellow-200 shadow-md rounded-lg p-6">
      ...
      <div className="mt-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-purple-100 p-4 rounded-md shadow-md">
            ...
            <h3 className="text-3xl font-bold text-purple-900">12</h3>
          </div>
          {/* Total Subcategories */}
          ...
          <div className="bg-green-100 p-4 rounded-md shadow-md">
            ...
            <h3 className="text-3xl font-bold text-green-900">54</h3>
          </div>
        </div>
      </div>
    </div>
