...
const getUser = async (req, res) => {
  try {
    ...
    res
      .status(500)
      .json({ msg: "someting wrong cannot able to find user by id" });
  }
};
...
const updateUser = async (req, res) => {
  try {
    ...
    res
      .status(200)
      .json({ msg: `user update successfully`, updateduser: updateuser });
  } catch (error) {
...
module.exports = { home, createUser, getUser, updateUser, deletUser };
